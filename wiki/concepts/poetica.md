...
> **Stato:** pagina in costruzione. Qui vive la tesi compositiva del paper CIM
> 2026 (cfr. `CLAUDE.md > Tesi paper`). Da consolidare durante la scrittura. La
> postura è personale e situata: mai formulare come "è meglio fare così".
...
- Posizionamento rispetto ai precursori CIM (granulazione offline, tempo
  differito, controllo parametrico gerarchico) — vedi ingest proceedings.
- Eredità Walter Branchi (pitagorica) — fonte da reperire.
- Sistemi dinamici e caos deterministico in composizione — fonti da reperire.
